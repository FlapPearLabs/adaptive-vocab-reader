...
输入：
- 交接归纳文档（本提示词的配套背景，必读）：`work/handoff/2026-08-02-ticket03.md` —— 含现状（main=`de2893a`、01/02 已归档真实验证证据）、权威来源优先级、下一步 Ticket 03 范围/非目标/验收示例、未决项与风险、安全边界、建议技能与交接输入清单。先于 Ticket 与 Spec 通读，可避免重复 01/02 已决事项与越界。
